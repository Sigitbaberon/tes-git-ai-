  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'medium': '0 4px 12px -2px rgb(0 0 0 / 0.12), 0 4px 6px -4px rgb(0 0 0 / 0.08)',
        'elevated': '0 12px 24px -4px rgb(0 0 0 / 0.15), 0 8px 12px -6px rgb(0 0 0 / 0.1)',
        'premium': '0 20px 40px -8px rgb(0 0 0 / 0.2), 0 8px 16px -4px rgb(0 0 0 / 0.1)',
